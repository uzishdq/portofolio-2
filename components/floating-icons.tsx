...
const Icon = ({
  ...
  const duration = React.useMemo(() => 5 + Math.random() * 5, []);
    ...
    >
      ...
      <div className="relative z-10 text-center px-4">
        <Typewriter
          ...
          speed={100}
          loop={true}
          className="text-5xl md:text-7xl font-bold tracking-tight bg-linear-to-b from-foreground to-foreground/70 text-transparent bg-clip-text"
        />
