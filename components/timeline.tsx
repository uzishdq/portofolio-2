  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-10">
        ...
        <p className="mt-3 max-w-2xl text-neutral-600 dark:text-neutral-400 text-sm md:text-base">
          A collection of full-stack projects I’ve built, focusing on real-world
          problems, clean architecture, and scalable solutions.
        </p>
      </div>
